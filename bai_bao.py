...
text1 = Text(box3,text="Người Việt mua ôtô điện nhiều thứ hai Đông Nam Á",size=30, color="red", align="top")
...
picture = Picture(box2, image="anh_xe_dien.png",  align="bottom")
